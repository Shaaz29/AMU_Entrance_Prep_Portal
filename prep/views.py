        ...
        try:
            ...
            def background_upload(file_path, m_id, original_name):
                try:
                    ...
                    connection.close()  # Keep isolated from WSGI
                    try:
                        os.remove(file_path)
                    except:
                        pass

            # Launching as a full detached system thread (non-daemon WSGI survival trick)
            ...
            messages.success(request, 'Upload started in the background! Depending on your data size, this will take 2 to 5 minutes to synthesize safely on Cloudinary. You can safely close or leave this page without interrupting it!')
